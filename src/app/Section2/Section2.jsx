        ...
        <div className='flex flex-col items-center text-center gap-[40px] py-[40px]'>
            ...
            <div className='bg-white justify-center flex h-[100vh] gap-[20px]'>
                <div className='flex flex-col gap-[10px]'>
                    {
                        content.map((n,index)=>(
                        <div className='flex items-center justify-between border-2 w-[20vw] py-[10px] px-[10px]' key={index}>
                    ...
                    <div className='w-[20vw]'>
                        <Image className='h-[62vh]' src="/images/gold-bar2.jpg" width={500} height={300}/>
                    </div>
                </div>
                <div className='h-[50vh] grid grid-cols-4 gap-[20px]'>
                    {
                        image.map((n,index)=>(
                            <div key={index} className='border-2 w-[17vw] flex flex-col items-center text-center gap-[10px] py-[10px] bg-[#D3D3D3]'>
                                <Image className='w-[15vw] h-[25vh] border-2' src={n.img} width={500} height={500}/>
                                <p>{n.header}</p>
